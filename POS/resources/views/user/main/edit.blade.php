            ...
            <div class="col-lg-6 offset-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{route('user#update', Auth::user()->id)}}" method="post" novalidate="novalidate" enctype="multipart/form-data">
                            @csrf
                                <div class="row">
                                 ...
                                 @endif
                                        ...
                                        <div class="form-group">
                                            <label  class="control-label mb-1 mt-2">Name</label>
